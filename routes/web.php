...
Route::middleware(['auth', 'company'])->group(function () {
    ...
    */
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        Route::post('/rewards/{id}/resolve', [Admin\RewardUsageController::class, 'resolve'])->name('rewards.resolve');
        Route::post('/rewards/{id}/unresolve', [Admin\RewardUsageController::class, 'unresolve'])->name('rewards.unresolve');
    });
});
