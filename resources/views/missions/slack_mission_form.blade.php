...
<head>
    ...
    <title>{{ $mission->title }} - ミッション達成</title>
        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-6 bg-white rounded-2xl shadow-sm ring-1 ring-gray-200 overflow-hidden">
                <div class="p-6 sm:p-8">
                    ...
                    <form method="POST" action="{{ route('slack.missions.submit', ['type' => $type]) }}" class="space-y-6">
                        @csrf
                        ...
                        @php
                            $titlePlaceholder = match($mission->key) {
                                ...
                                'event_organizer' => '例：社内LT会（12月）を企画・開催',
                                'acquire_certificate' => '例：AWS SAA 合格',
                                default => '例：実施した内容のタイトル',
                            };

                            $detailsHint = match($mission->key) {
                                'event_speaker' => '例：イベント名 / 対象者 / 発表内容の概要 / 学び',
                                'event_organizer' => '例：目的 / 参加人数 / 工夫した点 / 次回の改善',
                                'acquire_certificate' => '例：スコア・等級 / 学習時間 / 使った教材 / 学び',
