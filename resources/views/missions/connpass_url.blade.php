{{-- resources/views/missions/connpass_url.blade.php --}}
@extends('layouts.app')
...
<div class="max-w-lg mx-auto px-4 py-8 space-y-6">
    ...
    <div>
        <h1 class="text-xl font-semibold text-gray-900">Connpassイベント URL の送信</h1>
        <p class="text-sm text-gray-900 mt-1 font-medium">
            登壇または主催したConnpassイベントのURLを入力してください。送信するとミッションの進捗が更新されます。
        </p>
    </div>

    <form method="POST" action="{{ route('missions.connpass-url.submit') }}" class="space-y-4">
        @csrf
        ...
        <div>
            ...
            <input
                ...
                name="url"
                value="{{ old('url') }}"
                placeholder="https://connpass.com/event/123456/"
